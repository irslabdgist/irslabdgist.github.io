...
<p align="center">
 <img src="{{ site.url }}{{ site.baseurl }}/images/research_home2.jpg" width="100%">
</p>
...
#### Wireless-Centric AI
<span style="font-size: 14px; color:#0080FF"><i>"How to fully unleash the power of AI for wireless signals?"</i></span>
...
<span style="font-size: 14px; color:#0080FF"><i>"How to achieve new perception technologies/applications that can see beyond human vision?"</i></span>
...
<span style="font-size: 14px; color:#0080FF"><i>"How to achieve generalized perception capabilities by combining different physical capabilities of diverse sensors?"</i></span>
